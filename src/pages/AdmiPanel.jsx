    ...
    return (
        <main className="admin-panel">
            <aside className="admin-menu">
                ...
                <RegisterInstrumentButton className="admin-button" />
                <button onClick={() => setView("list")}>Listar Instrumentos</button>
                <button onClick={() => setView("manage-reservations")}>Gestionar Reservas</button>
                <button onClick={() => setView("manage-users")}>Gestionar Usuarios</button>
            </aside>
